        ...
        private async void UpdateScreen_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (info != null)
                {
                    ...
                    File.Delete(@"C:\DENEOS\core\deneOS.exe");
                    ...
                    client1.DownloadFile(downloadUrl, @"C:\DENEOS\core\deneOS.exe");
                    ...
                    client1.DownloadFile("https://repoficialx.xyz/deneOS/api/es.json", @"C:\DENEOS\lang\es.json");
                    client1.DownloadFile("https://repoficialx.xyz/deneOS/api/en.json", @"C:\DENEOS\lang\en.json");
